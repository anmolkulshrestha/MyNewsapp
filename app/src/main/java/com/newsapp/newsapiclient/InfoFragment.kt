...
import com.newsapp.newsapiclient.databinding.FragmentInfoBinding
...
class InfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentInfoBinding.share.setOnClickListener {
            var intent = Intent(Intent.ACTION_SEND)
            intent.type="text/plain"
            intent.putExtra(Intent.EXTRA_TEXT,article.url)
            startActivity(intent) }
        fragmentInfoBinding.note.setOnClickListener {
            var action = InfoFragmentDirections.actionInfoFragmentToBlankFragment(article)
